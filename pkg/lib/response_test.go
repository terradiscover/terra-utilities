...
func TestGone(t *testing.T) {
	...
	utils.AssertEqual(t, 410, response.StatusCode, "Example 410 response")
}
...
func TestErrorTimeout(t *testing.T) {
	...
	utils.AssertEqual(t, 408, response.StatusCode, "Example 408 response")
}
...
func TestErrorUnauthorized(t *testing.T) {
	...
	utils.AssertEqual(t, 401, response.StatusCode, "Example 401 response")
}
